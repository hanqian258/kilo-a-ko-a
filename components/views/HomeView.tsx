        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-20">
          ...
          <div className={`relative overflow-hidden rounded-3xl p-8 transition-all duration-300 hover:scale-[1.02] shadow-lg group ${isDark ? 'bg-slate-800' : 'bg-white'}`}>
            <div className="flex flex-col h-full justify-between relative z-10">
              ...
              <a href="https://kohalacenter.org/reefteach" target="_blank" rel="noopener noreferrer" className="absolute inset-0 z-20"><span className="sr-only">Visit ReefTeach</span></a>
            </div>
          </div>
        </div>
